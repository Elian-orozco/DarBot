  ...
  <div class="home-shell">
    <header class="site-header" :class="{ 'header-scrolled': scrolled }">
      <div class="header-inner">
        <router-link to="/" class="brand" aria-label="Inicio"><span class="brand-mark">DTP</span><span><strong>Dario Torregroza Perez</strong><small>Institución Educativa</small></span></router-link>
    ...
    <main>
      <section class="hero"><div class="hero-content"><div class="hero-text"><p class="eyebrow">Educación que transforma</p><h1>Dario Torregroza Perez</h1><p class="hero-lead">Una comunidad educativa que aprende, convive y construye futuro desde el territorio.</p><div class="hero-actions"><a href="#institucion" class="primary-button" @click.prevent="scrollTo('institucion')">Conoce nuestra institución <span>↘</span></a><a href="#noticias" class="text-link" @click.prevent="scrollTo('noticias')">Ver noticias</a></div></div><div class="hero-shield"><div class="shield-placeholder"><span>DTP</span><small>2026</small></div></div></div><div class="hero-note"><span>01</span><p>Formación integral<br>con sentido humano</p></div></section>
      ...
      <section class="stats-section reveal-section"><div class="section-wrap stats-grid"><div><strong>{{ noticias.length }}</strong><span>Noticias publicadas</span></div><div><strong>{{ eventos.length }}</strong><span>Eventos próximos</span></div><div><strong>24/7</strong><span>Atención digital</span></div><div><strong>DTP</strong><span>Comunidad educativa</span></div></div></section>
